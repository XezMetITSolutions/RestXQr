...
export default function MakarnaStation() {
  ...
  const STATION = 'makarna';
  const STATION_NAME = '🍝 Makarna İstasyonu';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      ...
      <div className="max-w-7xl mx-auto px-6 mb-6">
        <div className="flex gap-3 overflow-x-auto pb-2">
          ...
          <Link href="/mutfak/makarna" className="px-6 py-3 rounded-xl font-bold text-white shadow-lg" style={{ backgroundColor: STATION_COLOR }}>
            🍝 Makarna
          </Link>
      ...
      <div className="max-w-7xl mx-auto px-6">
        {loading ? (
          ...
          <div className="text-center py-20 bg-white rounded-2xl shadow-lg">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-3">Makarna İstasyonunda Sipariş Yok</h3>
                  ...
                  >
                    ...
                    <div className="space-y-3 mb-6">
                      {stationItems.map((item, idx) => (
                        <div key={idx} className="flex items-center gap-4 p-4 bg-blue-50 rounded-xl border-2 border-blue-200">
                          <div className="text-3xl font-black text-blue-600">{item.quantity}x</div>
                          <div className="flex-1">
                            <div className="font-bold text-lg text-gray-800">{item.name}</div>
                            {item.notes && <div className="text-sm text-blue-700 italic mt-1">📝 {item.notes}</div>}
                          </div>
                        </div>
                      ))}
                    </div>
