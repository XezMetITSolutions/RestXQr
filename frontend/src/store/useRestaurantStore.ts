  ...
  updateMenuItem: async (restaurantId: string, itemId: string, data: any) => {
    try {
      ...
      const backendData = {
        ...
        preparationTime: data.preparationTime === undefined ? undefined : (data.preparationTime || null),
        calories: data.calories === undefined ? undefined : (data.calories || null),
        allergens: data.allergens === undefined ? undefined : data.allergens,
        ingredients: data.ingredients === undefined ? undefined : (Array.isArray(data.ingredients) ? data.ingredients.join(', ') : (data.ingredients || null)),
        kitchenStation: data.kitchenStation === undefined ? undefined : (data.kitchenStation || null),
        type: data.type || 'single',
        bundleItems: data.bundleItems || [],
        variations: data.variations || [],
        options: data.options || [],
