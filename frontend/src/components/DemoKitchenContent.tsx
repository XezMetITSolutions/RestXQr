...
export default function DemoKitchenContent() {
    ...
    const getStatusInfo = (status: string) => {
        switch (status) {
            case 'pending':
                return { text: t('pending'), bg: '#fff3cd', color: '#856404' };
            case 'preparing':
                return { text: t('preparing'), bg: '#d4edda', color: '#155724' };
            case 'ready':
                return { text: t('ready'), bg: '#cce5ff', color: '#004085' };
            case 'completed':
                return { text: t('completed'), bg: '#d1ecf1', color: '#0c5460' };
            case 'cancelled':
                return { text: t('cancelled'), bg: '#f8d7da', color: '#721c24' };
            default:
                return { text: t('unknown'), bg: '#f0f0f0', color: '#333' };
        }
    };
                ...
                <div className="bg-yellow-50 rounded-2xl p-8 shadow-sm">
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-12 bg-white rounded-xl">
                            ...
                            <h3 className="text-xl font-semibold text-gray-800 mb-2">{t('noOrdersYet')}</h3>
                            <p className="text-gray-600">{t('newOrdersWillAppearHere')}</p>
                        </div>
                    ) : (
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-[2fr_2fr_1fr] gap-6">
                                            ...
                                            <div>
                                                <div className="flex items-start justify-between mb-4">
                                                    <div>
                                                        <div className="text-2xl font-bold text-gray-800">{t('table')} {order.tableNumber}</div>
                                                ...
                                                <div>
                                                    <div className="font-semibold text-gray-800 mb-2">{t('orderDetails')}:</div>
                                            ...
                                            <div>
                                                <div className="font-semibold text-gray-800 mb-3">{t('orderInfo')}:</div>
                                                <div className="space-y-3">
                                                    <div className="flex justify-between items-center">
                                                        <span className="text-gray-600">{t('estimatedTime')}:</span>
                                                        <span className="font-semibold text-gray-800">{estimatedTime} {t('minutes')}</span>
                                                    </div>
                                                    {order.notes && (
                                                        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 rounded">
                                                            <div className="font-semibold text-yellow-800 mb-1">📝 {t('specialNote')}:</div>
                        ...
                        <div className="p-6 overflow-y-auto flex-1">
                            {menuLoading ? (
                                ...
                                <div className="text-center py-12 bg-gray-50 rounded-lg">
                                    <div className="text-6xl mb-4">📋</div>
                                    <h3 className="text-xl font-semibold text-gray-800 mb-2">{t('noItemsYet')}</h3>
                                    <p className="text-gray-600">{t('addItemsToMenu')}</p>
                                </div>
                            ) : (
                                <div className="space-y-3">
                                    {menuItems.map((item) => (
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-4 border border-orange-200">
                                    <div className="text-orange-600 text-sm font-medium mb-1">{t('tableNumber')}</div>
                                    <div className="text-2xl font-bold text-orange-900">#{selectedOrder.tableNumber}</div>
                                </div>
                                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 border border-green-200">
                                    <div className="text-green-600 text-sm font-medium mb-1">{t('totalAmount')}</div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                    <div className="text-gray-600 text-sm font-medium mb-2">{t('orderStatus')}</div>
                                    <div
                                ...
                                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                    <div className="text-gray-600 text-sm font-medium mb-2">{t('orderTime')}</div>
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    <div className="text-xs text-gray-500">
                                                        {t('unitPrice')}: {(parseFloat(item.price.toString()) / item.quantity).toFixed(2)}₺
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            {selectedOrder.notes && (
                                <div className="bg-yellow-50 rounded-xl p-4 border border-yellow-200">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <div className="font-semibold text-yellow-900 mb-1">{t('orderNote')}</div>
                            ...
                            <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-4 border-2 border-purple-200">
                                <div className="flex items-center justify-between">
                                    <div className="text-gray-700 font-medium">{t('totalItemCount')}</div>
                                    <div className="text-xl font-bold text-purple-700">
                                        {selectedOrder.items.reduce((sum, item) => sum + item.quantity, 0)} {t('pieces')}
                                    </div>
                                </div>
                                <div className="flex items-center justify-between mt-3 pt-3 border-t border-purple-200">
                                    <div className="text-gray-900 font-bold text-lg">{t('totalAmount')}</div>
