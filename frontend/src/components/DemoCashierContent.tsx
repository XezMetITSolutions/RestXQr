            ...
            <div className="max-w-7xl mx-auto">
                ...
                {loading ? (
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-12 text-center">
                        ...
                        <h3 className="text-xl font-semibold text-gray-600 mb-2">{t('noPendingPayments')}</h3>
                        <p className="text-gray-500">{t('newOrdersWillAppearHere')}</p>
                    </div>
                ) : (
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="text-xl font-bold text-gray-800">{t('table')} {order.tableNumber}</div>
                                ...
                                <div className="flex items-center justify-between mb-4 p-3 bg-white rounded-lg">
                                    <div className="text-lg font-bold text-gray-800">{t('total')}</div>
            ...
            {showPaymentModal && selectedOrder && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-2xl p-8 max-w-md w-full">
                        <h2 className="text-2xl font-bold text-gray-800 mb-4">{t('confirmPayment')}</h2>

                        <div className="mb-6">
                            <div className="text-center mb-4">
                                <div className="text-4xl font-bold text-gray-800 mb-2">{t('table')} {selectedOrder.tableNumber}</div>
