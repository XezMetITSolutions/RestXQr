        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              ...
              <Link href="/demo-paneller" className="px-12 py-6 bg-white/10 backdrop-blur-xl text-white rounded-2xl text-xl font-bold border-2 border-white/30 hover:bg-white/20 transition-all duration-300 hover:scale-110 flex items-center justify-center">
